					...
					<thead>
						<tr>
							...
							<td class="float-left"><form:errors path="firstName"
									class="text-danger" /> <form:input class="form-control"
									path="firstName" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="float-left"><form:errors path="location"
									class="text-danger" /> <form:input class="form-control"
									path="location" /></td>
			...
			<form:form action="/login" method="post" modelAttribute="newLogin">
				...
				<table class="mx-1">
					...
					<thead>
						...
						<tr>
							<td class="float-left">Password:</td>
							<td class="float-left"><form:input class="form-control"
									type="password" path="password" /></td>
						</tr>
						<tr>
